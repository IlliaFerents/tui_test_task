...
Note for AI:
TUI NL is really heavy app, slow when running in pwt ui mode, and generally is slow
Lots of broken html semantics and aria implemenation
mixed locator strategy(some elements have data-test-id, some have labels, some only ugly classe)